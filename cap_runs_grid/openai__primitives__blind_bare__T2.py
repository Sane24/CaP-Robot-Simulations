# model=openai condition=primitives profile=blind_bare task=T2
...
say_verified(lambda: is_placed('red block', 'green block'),
             'Done, the red block is stacked on the green block.',
             'The red block is not stacked on the green block.')
