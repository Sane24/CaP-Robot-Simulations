...
# generated=2026-08-05T06:39:35
# prompt_chars=12840
# tokens_in=4116 tokens_out=269
# seconds=4.5
...
if np.linalg.norm(np.array(blue_pos) - expected_pos) < 0.05:
  say(f'Success - the blue block is now between the red block and the {second_from_left}')
else:
  say(f'The action may not have fully succeeded. The blue block is not exactly between the red block and the {second_from_left}')
