...
# generated=2026-08-05T07:08:28
# prompt_chars=15348
# tokens_in=4921 tokens_out=169
# seconds=4.8

block_names = parse_obj_name('blocks sorted left to right', f'objects = {get_obj_names()}')
second_from_left = block_names[1]
