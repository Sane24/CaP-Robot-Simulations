...
# generated=2026-08-05T07:14:26
# prompt_chars=15340
# tokens_in=4917 tokens_out=237
# seconds=4.3

say('Ok - putting blocks on corners clockwise starting at top right')
corners = ['top right corner', 'bottom right corner', 'bottom left corner', 'top left corner']
block_names = parse_obj_name('the blocks', f'objects = {get_obj_names()}')
confirm_before('put blocks on corners clockwise starting at top right corner')
for i, (block_name, corner) in enumerate(zip(block_names, corners)):
    ...
    say_verified(lambda b=block_name, p=corner_pos: is_at(b, p),
