...
# generated=2026-08-05T07:05:05
# prompt_chars=15307
# tokens_in=4908 tokens_out=232
# seconds=4.2
...
for i, (block_name, pos) in enumerate(zip(block_names, corners)):
    say_progress(i + 1, len(block_names), f'placing the {block_name} on a corner')
    put_first_on_second(block_name, pos)
    say_verified(lambda b=block_name, p=pos: is_at(b, p),
                 f'The {block_name} is at the corner.',
                 f'The {block_name} did not end up at the corner.')
