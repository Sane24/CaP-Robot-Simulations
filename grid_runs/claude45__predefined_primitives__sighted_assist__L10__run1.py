...
# generated=2026-08-05T07:40:12
# prompt_chars=15361
# tokens_in=4924 tokens_out=321
# seconds=5.9
...
total = len(fruits) + len(bottles)
step = 0
for fruit in fruits:
    step += 1
    say_progress(step, total, f'placing the {fruit} on the green plate')
...
for bottle in bottles:
    step += 1
    say_progress(step, total, f'placing the {bottle} on the blue plate')
